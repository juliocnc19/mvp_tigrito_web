    ...
    <header className="bg-card border-b border-border px-4 py-3">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-semibold text-[var(--color-neutral-text)]">Modo Profesional</h1>
            <p className="text-sm text-[var(--color-neutral-text-tertiary)]">¡Encuentra trabajos y gana dinero!</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          {/* Balance */}
          <div className="flex items-center gap-2 bg-[var(--color-success-light)] px-3 py-2 rounded-lg">
